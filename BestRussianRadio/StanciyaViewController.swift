...
class StanciyaViewController: UIViewController {
    ...
    func setupPullToRefresh() {
        ...
        refreshControl.tintColor = UIColor(hexValue: "#3D3BEE", alpha: 1)
...
extension StanciyaViewController: UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if stations.isEmpty {
            ...
            let cell = tableView.dequeueReusableCell(withIdentifier: "StationCell", for: indexPath) as! RadioStanciyaTableViewCell
...
extension StanciyaViewController: UITableViewDelegate {
...
extension StanciyaViewController: UISearchResultsUpdating {
...
extension StanciyaViewController: RadioPlayerDelegate {
...
extension StanciyaViewController {
...
extension StanciyaViewController: NowPlayingViewControllerDelegate {
